...
contract FloatiesTest is Test {
  ...
  function testUpgrade() public {
    ...
    floaties = Floaties(0x56B10bf5E47C8262569F3119Dfb4bE457795C8a2);
    vm.stopPrank();
    address minter = address(111);
    vm.deal(minter, 100 ether);
    vm.startPrank(minter);
    uint amount = 0.002 ether;
    uint256 amountOut = floaties.calculateEthToTn100x(amount);
    floaties.swapEthForFloaties{ value: amount }(amountOut, "");
    
    console.log(floaties.balanceOf(minter, hex"f09fa684"));
    vm.stopPrank();
  }
